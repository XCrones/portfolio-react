...
import { showPoup } from "../../store/slices/shop/popupSlice";
import { calcRate, filterBy, ProductItem } from "../../store/slices/shop/products.slice";
...
const ProductsComponent = () => {
  ...
  const sort = (arr: ProductItem[]): ProductItem[] => {
  ...
  const filterSearchProducts = (arr: ProductItem[]): ProductItem[] => {
    return arr.filter((v) => v.title.toLowerCase().trim().includes(valueSearch.toLowerCase().trim()));
  };
