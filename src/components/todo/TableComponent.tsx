...
import { ITasks, sortItems, toggleComplete } from "../../store/slices/todo/listSlice";
...
const TableComponent = () => {
  ...
  const parsePriority = (value: number): string => {
  ...
  return (
    <table className="w-full border-separate border-spacing-y-2 table-todos">
      <thead>
